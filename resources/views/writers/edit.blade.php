...
<section class="bg-white pb-8">
    ...
    <div class="container max-w-5xl mx-auto m-8">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Form Penulis</h1>
        ...
        <div class="d-block">
            <div
                ...
                <form action="{{ url('/writers/update/'.$writers->id) }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="name" name="name" type="text" placeholder="Nama Penulis" autocomplete="off"
                            value="{{ $writers->name }}" autofocus>
