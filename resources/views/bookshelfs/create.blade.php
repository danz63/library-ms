                ...
                <form action="{{ url('/bookshelfs/store') }}" method="POST" class="md:w-full sm:w-full sm:mx-auto">
                    ...
                    <div class="flex items-center justify-between">
                        <button type="submit" name="submit" value="Submit"
                            class="mx-auto lg:mx-0 bg-blue-500 hover:bg-blue-400 text-gray-100 font-bold rounded-full py-2 mx-2 shadow-lg cursor-pointer w-1/3 transition duration-300">Simpan</button>
                        <button type="button" onclick="window.history.back();"
                            class="mx-auto lg:mx-0 bg-red-500 hover:bg-red-400 text-gray-100 font-bold rounded-full py-2 mx-2 shadow-lg cursor-pointer w-1/3 transition duration-300">Kembali</button>
                    </div>
                </form>
            </div>
        </div>
