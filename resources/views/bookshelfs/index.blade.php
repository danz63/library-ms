...
@section('title','Rak Buku | Library Management System')
@section('content')
                    ...
                    <thead>
                        <tr>
                            <th
                                ...
                                #</th>
                            <th
                                class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell w-8/12">
                                Rak</th>
                            <th
                                class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell w-3/12">
                                Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($bookshelfs as $bs)
                        <tr
                            ...
                            <td
                                class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static">
                                <span
                                    class="lg:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Rak</span>
                                {{ $bs->name }}
                            </td>
                            <td
