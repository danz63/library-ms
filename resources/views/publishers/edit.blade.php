...
<section class="bg-white pb-8">
    ...
    <div class="container max-w-5xl mx-auto m-8">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Form Penerbit</h1>
        ...
        <div class="d-block">
            <div
                ...
                <form action="{{ url('/publishers/update/'.$publishers->id) }}" method="POST"
                    class="md:w-full sm:w-full sm:mx-auto">
                    @csrf
                    @method('patch')
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="name" name="name" type="text" placeholder="Nama Penerbit" autocomplete="off"
                            value="{{ $publishers->name }}" autofocus>
                    ...
                    <div class="flex items-center justify-between">
                        <button type="submit" name="submit" value="Submit"
                            class="mx-auto lg:mx-2 sm:mx-0 bg-blue-500 hover:bg-blue-400 text-gray-100 font-bold rounded-full py-2 mx-2 shadow-lg cursor-pointer lg:w-2/3 md:w-2/3 sm:w-full sm:block transition duration-300 focus:outline-none focus:shadow-outline">Perbaharui</button>
